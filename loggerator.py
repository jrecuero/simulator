...
# ===========================================================================
def getLoggerator(name, color=(BOLD_ON + FG_WHITE)):
...
class Loggerator(object):
    ...
    def __init__(self, name, color):
        ...
        color        = color if self._useColor() else ""
        color_reset  = COL_RESET if self._useColor() else ""
    ...
    def _useColor(self):
        ...
        """
        _os = sys.platform
        if 'win' in _os and 'darwin' not in _os:
            return False
        global _useColor
        return _useColors
    ...
    def _log(self, message, level, color=None, *args, **kwargs):
        ...
        """
        color       = self._setColor(color) if self._useColor() else ""
        color_reset = COL_RESET if self._useColor() else ""
